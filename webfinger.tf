...
data "google_iam_policy" "public-static" {
  binding {
...
resource "google_storage_bucket_iam_policy" "public-static" {
  bucket      = google_storage_bucket.static.name
  policy_data = data.google_iam_policy.public-static.policy_data
}
